...
if __name__ == '__main__':
	...
	st.markdown('As we can see, '
		'**:blue[Line 1 - blue]** has kept the same participation after the COVID period. Although, it has decreased in the previous period. '
		'**:green[Line 2 - green]**, after the fall caused by the COVID pandemic, recovered the participation level previous. '
		'**:red[Line 3 - red]** is decreasing, inclusive with this pattern before of COVID pandemic. '
		'**:yellow[Line 4 - yellow]**, after the COVID period shows a growing pattern in demand for passengers in your line. '
		'**:purple[Line 5 - lilac]** kept a growing pattern until the begun 2021, next it has slowly decreasing. '
		'Finally, **:silver[line 15 - silver]** has a growing pattern in this period. Although, the participation of this line is small yet.')
